...
INSERT INTO article (id, name, description, time, yearMonth, quantity, date_creation, date_edit, owner) VALUES (1,'vestido vintage','color rojo', 2, 'Y', 1,'2016-09-20' ,'2016-09-20', 2);
INSERT INTO article (id, name, description, time, yearMonth, quantity, date_creation, date_edit, owner) VALUES (2,'libro harry potter','Cádiz del FUego', 5, 'M', 1, '2016-09-20','2016-09-20', 2);
